...
const OutletsChart = () => {
    ...
    const realisticData = {
        "مقبس ١": [1.2, 1.3, 1.1, 1.4, 1.35, 1.25, 3.22, 1.1],
        "مقبس ٢": [0.6, 0.7, 0.65, 0.75, 0.8, 0.78, 0.72, 0.65],
        "مقبس ٣": [0.4, 0.5, 0.45, 0.52, 0.51, 0.49, 0.5],
        "مقبس ٤": [0.3, 0.35, 0.32, 0.38, 0.36, 0.34, 0.3],
        "مقبس ٥": [1.8, 1.9, 1.7, 1.85, 1.9, 1.88, 1.82, 1],
        "مقبس ٦": [0.9, 1.0, 0.95, 1.1, 1.05, 1.02, 1.0, 4.25],
        "مقبس ٧": [0.2, 0.25, 0.22, 0.28, 0.26, 0.24, 0.23, 0.33],
        "مقبس ٨": [1.1, 1.2, 1.15, 1.3, 1.18, 1.16, 1.12, 2.11],
        "مقبس ٩": [0.5, 0.55, 0.53, 0.57, 0.56, 0.54, 0.5, 0.88],
        "مقبس ١٠": [0.4, 0.45, 0.43, 0.48, 0.46, 0.44, 0.42, 0.91],
    };

    // Function to generate data based on the selected outlet
    const getData = () => {
        return {
            labels: ["مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
            datasets: [{
