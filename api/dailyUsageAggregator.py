...
app = Flask(__name__)
cred = credentials.Certificate('/Users/basmaalsulaim/Desktop/GP/FIREBASE_CREDENTIALS/murshid-f076f-firebase-adminsdk-7lhjc-44d33f50b0.json') # REPLACE WITH FIREBASE SERVICE ACCOUNT CREDENTIALS FILE PATH IN YOUR COMPUTER
firebase_admin.initialize_app(cred)
